...
private let kMEDSpinningAnimationKey = "Rotation"

@IBDesignable public class MEDActivityIndicatorView: UIView {
    ...
    private func animate(animated: Bool) {
        if animated {
            ...
            if self.isAnimating == false {
                // create or resume
                if self.circlePathLayer.animation(forKey: kMEDSpinningAnimationKey) == nil {
